...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_styles')
        @loadOnce(asset('packages/simplemde/dist/simplemde.min.css'))
        <style type="text/css">
    ...
    @push('crud_fields_scripts')
        @loadOnce(asset('packages/simplemde/dist/simplemde.min.js'))
        <script>
            function bpFieldInitSimpleMdeElement(element) {
                ...
                // HACK: Apply local extensions in mix/resources/js/admin/simplemde.js
                configurationObject = extendSimplemdeAttributes(configurationObject);
