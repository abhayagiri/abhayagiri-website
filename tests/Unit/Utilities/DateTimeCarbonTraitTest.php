...
class DateTimeCarbonTraitTest extends TestCase
{
    public function testEnglishEST()
    {
        ...
        $this->assertEquals('<time datetime="2019-06-23T05:23:49.000000Z">June 23, 2019</time>', $dt->formatUserDateHtml());
        $this->assertEquals('<time datetime="2019-06-23T05:23:49.000000Z">June 23, 2019 1:23 AM</time>', $dt->formatUserDateTimeHtml());
    }
    ...
    public function testEnglishPST()
    {
      $this->assertEquals('America/Los_Angeles', Config::get('abhayagiri.human_timezone'));
        ...
        $this->assertEquals('<time datetime="2019-06-23T05:23:49.000000Z">June 22, 2019</time>', $dt->formatUserDateHtml());
        $this->assertEquals('<time datetime="2019-06-23T05:23:49.000000Z">June 22, 2019 10:23 PM</time>', $dt->formatUserDateTimeHtml());
    }
    ...
    public function testThaiEST()
    {
        ...
        $this->assertEquals('<time datetime="2019-06-23T05:23:49.000000Z">23 มิถุนายน 2019</time>', $dt->formatUserDateHtml());
        $this->assertEquals('<time datetime="2019-06-23T05:23:49.000000Z">23 มิถุนายน 2019 เวลา 1:23</time>', $dt->formatUserDateTimeHtml());
    }
    ...
    public function testThaiPST()
    {
        ...
        $this->assertEquals('<time datetime="2019-06-23T05:23:49.000000Z">22 มิถุนายน 2019</time>', $dt->formatUserDateHtml());
        $this->assertEquals('<time datetime="2019-06-23T05:23:49.000000Z">22 มิถุนายน 2019 เวลา 22:23</time>', $dt->formatUserDateTimeHtml());
    }
}
