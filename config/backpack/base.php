...
return [
    ...
    */
    ...
    'default_datetime_format' => 'MMM D, YYYY, h:mm A',
    ...
    'project_logo'   => '<b>ABM</b>in',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-light border-0 navbar bg-yellow',
    ...
    'body_class' => 'app aside-menu-fixed sidebar-lg-show bg-yellow',
        // Try sidebar-hidden, sidebar-fixed, sidebar-compact, sidebar-lg-show

    // Sidebar element classes.
    'sidebar_class' => 'sidebar sidebar-pills bg-light bg-yellow',
    ...
    'footer_class' => 'app-footer bg-yellow',
        // hide it with d-none
