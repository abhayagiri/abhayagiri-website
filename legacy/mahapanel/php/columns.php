...
class TableData {
    ...
    public function get($table, $index_column, $columns, $filter) {
        ...
        foreach ($rResult as $aRow) {
            ...
            $id = $aRow['id'];
            $url = $aRow['title'];
            if ($url == "title" || $url == "url_title" || $url == "date" || $url == "user" || $url == "status") {
                $edit = "<button class='btn btn-small btn-primary' onclick='navEdit($id,\"no\")'><i class='icon-pencil'></i> Edit</button>";
            } else {
