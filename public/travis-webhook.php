...
// Courtesy of https://github.com/Techtony96/TravisCI-Webhooks
...
$TRAVIS_WEBHOOK_URL = getenv('TRAVIS_WEBHOOK_URL');
if (!$TRAVIS_WEBHOOK_URL) {
...
$response = file_get_contents($TRAVIS_WEBHOOK_URL, false, $context);

function getRepoURL($data) {
  return 'https://github.com/' . $data['repository']['owner_name'] . '/' . $data['repository']['name'];
}
