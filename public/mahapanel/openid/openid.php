...
class LightOpenID {
    ...
    function request($url, $method = 'GET', $params = array(), $update_claimed_id = false) {
        if (
    ...
    function discover($url) {
        $url = str_replace('http:', 'https:', $url); //a dirty
        if (!$url)
    ...
    function validate() {
        ...
        if ($this->data['openid_return_to'] != "https://mahapanel.abhayagiri.org/openid/login.php") {
