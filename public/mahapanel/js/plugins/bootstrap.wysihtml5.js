...
window.rangy=function(){
    function b(a,b){
        ...
        function d(a){
        return function(b,c){
            for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0
            }
        }
    function e(a){
...
if(typeof window==j)f("No window found");
else if(typeof document==j)f("No document found");else return b(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),b(window,"addEventListener")?window.addEventListener("load",s,!1):b(window,"attachEvent")?window.attachEvent("onload",
...
rangy.createModule("DomUtil",function(b,c){
    function a(a){
        ...
        for(d=b;d;d=d.parentNode)if(m(c,d))return d;return null
        }
        function e(a,b,c){
    ...
    var m=function(a,b){
        for(var c=a.length;c--;)if(a[c]===b)return!0;return!1
        };
...
rangy.createModule("DomRange",function(b){
    function c(a,b){
        ...
        function d(a,b,c){
        if(b=a._listeners[b])for(var d=0,h=b.length;d<h;++d)b[d].call(a,{
            target:a,
            args:c
        })
        }
        ...
        for(var d,e,c=c||{
            ...
            d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
            b(d)){
            c.stop=!0;
            break
        }else{
...
q.prototype={
    ...
    getSubtreeIterator:function(){
        var b;
        if(this.isSingleCharacterDataNode)b=this.range.cloneRange(),b.collapse();
        else{
...
rangy.createModule("WrappedSelection",function(b,c){
    function a(a){
        ...
        function i(a){
        var b=a.getNodes(),c;
            a:if(!b.length||1!=b[0].nodeType)c=!1;
            else{
            c=1;
        ...
        function k(a){
        a._ranges.length=0;
        if("None"==a.docSelection.type)f(a);
        else{
            var c=a.docSelection.createRange();
            if(c&&"undefined"!=typeof c.text)h(a,c);
            else{
...
if(!D&&E&&s.areHostMethods(t,["removeAllRanges","addRange"])){
    ...
    u.addRange=N?function(a,c){
        if(l&&v&&this.docSelection.type=="Control")j(this,a);
        else if(c&&I)L(this,a);
        else{
            var d;
            if(J)d=this.rangeCount;
            else{
    ...
    function(){
        try{
            ...
            if(this.docSelection.type!="None"){
                var a;
                if(this.anchorNode)a=m.getDocument(this.anchorNode);
...
f(this)
    ...
    if(this.docSelection.type=="Control")j(this,a);
    else{
...
if(D)G=function(a){
    var c;
    if(b.isSelectionValid(a.win))c=a.docSelection.createRange();
    else{
    ...
    if(l&&v&&a.docSelection.type=="Control")k(a);
    else{
    ...
    typeof K.collapsed&&b.features.implementsDomRange)G=function(a){
    var b;
    b=a.nativeSelection;
    if(b.anchorNode){
        b=B(b,0);
...
Base.extend=function(b,c){
    ...
    var e=d.constructor,f=d.constructor=function(){
        if(!Base._prototyping)if(this._constructing||this.constructor==f)this._constructing=!0,e.apply(this,arguments),delete this._constructing;
            else if(null!=arguments[0])return(arguments[0].extend||a).call(arguments[0],d)
            };
...
Base=Base.extend({
    ...
    ancestor:Object,
    version:"1.1",
    forEach:function(b,c,a){
        for(var d in b)void 0===this.prototype[d]&&c.call(a,b[d],d,b)
            },
    implement:function(){
        for(var b=0;b<arguments.length;b++)if("function"==typeof arguments[b])arguments[b](this.prototype);else this.prototype.extend(arguments[b]);return this
        },
    toString:function(){
        return""+this.valueOf()
        }
...
wysihtml5.lang.array=function(b){
    return{
        contains:function(c){
            ...
            for(var a=0,d=b.length;a<d;a++)if(b[a]===c)return!0;return!1
            },
        without:function(c){
...
wysihtml5.lang.object=function(b){
    return{
        merge:function(c){
            for(var a in c)b[a]=c[a];return this
            },
        get:function(){
            return b
            },
    ...
    wysihtml5.lang.string=function(a){
        ...
        return{
            ...
            interpolate:function(b){
                for(var c in b)a=this.replace("#{"+c+"}").by(b[c]);return a
                },
            replace:function(b){
                return{
                    by:function(c){
...
wysihtml5.dom.getAsDom=function(){
    ...
    return function(c,a){
        var a=a||document,d;
        if("object"===typeof c&&c.nodeType)d=a.createElement("div"),d.appendChild(c);
        else if(wysihtml5.browser.supportsHTML5Tags(a))d=a.createElement("div"),d.innerHTML=c;
        else{
            d=a;
...
wysihtml5.dom.parse=function(){
    function b(c,e){
        ...
        1:function(a){
            ...
            if(x)for(t in x)if(s=h[x[t]])s=s(c(a,t)),"string"===typeof s&&(i[t]=s);r&&w.push(r);
            if(m)for(t in m)if(s=k[m[t]])r=s(c(a,t)),"string"===typeof r&&w.push(r);o["_wysihtml5-temp-placeholder"]=1;
    ...
    return function(d){
        c.observe(d.element,"keydown",function(e){
            if(e.keyCode===b.BACKSPACE_KEY){
                ...
                e.firstChild&&b.lang.array(a).contains(e.firstChild.nodeName)&&(f=c.getParentElement(f,{
                    nodeName:a
...
(function(b){
    ...
    b.quirks.insertLineBreakOnReturn=function(e){
        ...
        if(!(g.shiftKey||i!==b.ENTER_KEY&&i!==b.BACKSPACE_KEY)){
            ...
            {
                nodeName:a
            },4))?"LI"===h.nodeName&&(i===b.ENTER_KEY||i===b.BACKSPACE_KEY)?setTimeout(function(){
                var a=e.selection.getSelectedNode(),b;
                a&&((b=c.getParentElement(a,{
                    nodeName:d
                },2))||f(a))
    ...
    postApply:function(a,b){
        for(var c=a[0],d=a[a.length-1],f=[],g,i=c,m=d,s=0,x=d.length,o,z,w=0,y=a.length;w<y;++w)if(o=a[w],z=this.getAdjacentMergeableTextNode(o.parentNode,!1)){
            if(g||(g=new e(z),f.push(g)),g.textNodes.push(o),o===c&&(i=g.firstTextNode,s=i.length),o===d)m=g.firstTextNode,x=g.getLength()
                }else g=null;if(c=this.getAdjacentMergeableTextNode(d.parentNode,!0))g||(g=new e(d),f.push(g)),g.textNodes.push(c);
        if(f.length){
            w=0;
            for(y=
...
areElementsMergeable:function(a,b){
    ...
    if(d=c.dom.arrayContains(this.tagNames,(a.tagName||"").toLowerCase()))if(d=c.dom.arrayContains(this.tagNames,(b.tagName||
        "").toLowerCase()))if(d=a.className.replace(i," ")==b.className.replace(i," "))a:if(a.attributes.length!=b.attributes.length)d=!1;
        else{
        d=0;
...
(function(b){
    function c(c,g){
        ...
        for(h=j.length;k<h;k++)for(p in n=j[k],n.removeAttribute("class"),g)n.setAttribute(p,g[p]);k=n;
    ...
    b.commands.createLink={
        exec:function(a,b,d){
            ...
            h?a.selection.executeAndRestore(function(){
                for(var a=h.length,b=0,c,d,f;b<a;b++)c=h[b],d=e.getParentElement(c,{
                    nodeName:"code"
                }),f=e.getTextContent(c),f.match(e.autoLink.URL_REG_EXP)&&!d?e.renameElement(c,"code"):e.replaceWithChildNodes(c)
                    }):(d="object"===typeof d?d:{
                href:d
            },c(a,d))
            },
...
(function(b){
    ...
    b.commands.formatInline={
        ...
        state:function(d,f,g,i,h){
            var f=d.doc,k=a[g]||g;
            if(!b.dom.hasElementWithTagName(f,g)&&!b.dom.hasElementWithTagName(f,k)||i&&
                !b.dom.hasElementWithClassName(f,i))return!1;
...
(function(b){
    b.commands.insertImage={
        exec:function(c,a,d){
            var d="object"===typeof d?d:{
                src:d
            },e=c.doc,a=this.state(c),f;
            if(a)c.selection.setBefore(a),d=a.parentNode,d.removeChild(a),b.dom.removeEmptyTextNodes(d),"A"===d.nodeName&&!d.firstChild&&(c.selection.setAfter(d),d.parentNode.removeChild(d)),b.quirks.redraw(c.element);
            else{
                a=e.createElement("IMG");
                for(f in d)a[f]=d[f];c.selection.insertNode(a);
...
(function(b){
    b.commands.insertOrderedList={
        exec:function(c,a){
            var d=c.doc,e=c.selection.getSelectedNode(),f=b.dom.getParentElement(e,{
                nodeName:"OL"
            }),g=b.dom.getParentElement(e,{
                nodeName:"UL"
            }),e="_wysihtml5-temp-"+(new Date).getTime(),i;
        ...
        state:function(c){
            ...
            return b.dom.getParentElement(c,{
                nodeName:"OL"
            })
            },
        value:function(){}
        ...
        _initAutoLinking:function(){
            ...
            if(this.config.autoLink){
                ...
                c.observe(this.element,"keydown",function(a){
                    if(g.length){
                        var a=d.selection.getSelectedNode(a.target.ownerDocument),b=c.getParentElement(a,{
                            nodeName:"A"
                        },4),e;
...
!function($, wysi) {
    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
            "<div class='btn-group'>" +
            "<a class='btn btn-wysihtml5" + size + "' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "' tabindex='-1'><i class='icon-list btn-wysihtml5'></i></a>" +
            "<a class='btn btn-wysihtml5" + size + "' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><i class='icon-th-list btn-wysihtml5'></i></a>" +
            "<a class='btn btn-wysihtml5" + size + "' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "' tabindex='-1'><i class='icon-indent-right btn-wysihtml5'></i></a>" +
            "<a class='btn btn-wysihtml5" + size + "' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class='icon-indent-left btn-wysihtml5'></i></a>" +
            "</div>" +
            "</li>";
        },
        ...
        "link": function(locale, options) {
            ...
            "</div>" +
            "</div>" +
            "<a class='btn btn-wysihtml5" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='icon-share btn-wysihtml5'></i></a>" +
            "</li>";
        },
        ...
        "image": function(locale, options) {
            ...
            "</div>" +
            "<div class='modal-body'>" +
            "<input id='wysiwyg-upload' name='wysiwyg-upload' type='file' class='bootstrap-wysihtml5-insert-image-url choose-file'>" +
            "</div>" +
            "<div class='modal-footer'>" +
            ...
            "</div>" +
            "</div>" +
            "<a class='btn btn-wysihtml5" + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><i class='icon-picture btn-wysihtml5'></i></a>" +
            "</li>";
        },
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
            ...
            var insertImage = function() {
                ajaxFileUpload('wysiwyg-upload','img',function(data){
